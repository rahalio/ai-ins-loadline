/**
 * ObservationRepository - DynamoDB Implementation
 *
...
/**
 * ObservationRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Observation repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ObservationRepository } from "@loadline/services/experience";
...
/**
 * ObservationRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: EXPERIENCE_OBSERVATION
 * Entity Token: EXPERIENCE_OBSERVATION
 * SK Prefix: EXPERIENCE_OBSERVATION
 */
export class ObservationRepositoryDdb implements ObservationRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "EXPERIENCE_OBSERVATION";
  private readonly ENTITY_TOKEN = "EXPERIENCE_OBSERVATION";
  private readonly SK_PREFIX = "EXPERIENCE_OBSERVATION";
  ...
  private readonly ENTITY_TYPE_PK = "EXPERIENCE_OBSERVATIONS";
