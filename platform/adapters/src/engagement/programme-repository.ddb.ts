/**
 * ProgrammeRepository - DynamoDB Implementation
 *
...
/**
 * ProgrammeRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Programme repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ProgrammeRepository } from "@loadline/services/engagement";
...
/**
 * ProgrammeRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ENGAGEMENT_PROGRAMME
 * Entity Token: ENGAGEMENT_PROGRAMME
 * SK Prefix: ENGAGEMENT_PROGRAMME
 */
export class ProgrammeRepositoryDdb implements ProgrammeRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ENGAGEMENT_PROGRAMME";
  private readonly ENTITY_TOKEN = "ENGAGEMENT_PROGRAMME";
  private readonly SK_PREFIX = "ENGAGEMENT_PROGRAMME";
  ...
  private readonly ENTITY_TYPE_PK = "ENGAGEMENT_PROGRAMMES";
