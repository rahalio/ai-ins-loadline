/**
 * Engagement Services - Application Layer Export
 *
...
/**
 * Engagement Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for engagement domain.
 */
