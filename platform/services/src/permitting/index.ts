/**
 * Permitting Services - Application Layer Export
 *
...
/**
 * Permitting Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for permitting domain.
 */
